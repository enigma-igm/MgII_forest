...
for ind, elem in enumerate(iqso_to_plot):
    raw_data_out, masked_data_out, all_masks_out = mutils.init_onespec(elem, redshift_bin, datapath=datapath)
    ...
    ax.plot(wave[wave_mask], (flux / fluxfit)[wave_mask], c='k', drawstyle='steps-mid', label=qso_namelist[elem])
