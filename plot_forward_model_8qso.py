...
iqso_to_use = [0, 1, 4, 5, 6, 7] # omitting new qso in the plotting
...
for iqso in iqso_to_use:
    ...
    for i in range(ncovar):
        ...
        ax.plot(vel_data, flux_lores_comb[:len(vel_data)] + (i+1), 'tab:blue', alpha=fm_spec_alpha, drawstyle='steps-mid')
